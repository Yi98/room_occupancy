...
window.generateReport = function (data, peopleChart, temperatureChart, humidityChart) {
    ...
    doc.fontSize(17).text("Insights", 50, 170, {align: "center"});
